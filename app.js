...
let gameBegins = () => {
    ...
    prompt("Earth is being invaded! A swarm of aliens has come to destroy Earth! Take control of the USS Schwarzenegger, and keep the attackers at bay until reinforcements arrive ")
...
if (playerShip.hull > 0) {               
            ...
            if (playerShip.accuracy >= Math.random()) {
                ...
                prompt(" enemies remaining: " + alienShips.length +  "; health remaining: " 
                + playerShip.hull + "");
            } else {
                // if you missed
            }                     
            ...
            prompt("You have lost! try again!!! ");
        }
        ...
        // when the
            ...
            if(alienShips.length == 0) {
                prompt("You have defeated the enemy. Refresh the browser to play again");
                break;
            }
